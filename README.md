...
The code here could be run using, for example 
`python setup.py build_ext --inplace && python run_pipeline.py --input ./input_images_test/5/ --output ./output_images_test/ --rect 100 1 400 300 --blur_kernel 51`.
